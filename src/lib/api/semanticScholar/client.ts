...
// }
// const apiKey = process.env.NEXT_PUBLIC_SEMANTIC_SCHOLAR_API;
const apiKey =
  process.env.SEMANTIC_SCHOLAR_API_KEY ??
  process.env.S2_API_KEY ??
  "";
if (!apiKey) {
  throw new Error("Semantic Scholar API key is missing.");
}
semanticScholarClient.defaults.headers.common["x-api-key"] = apiKey.trim();
